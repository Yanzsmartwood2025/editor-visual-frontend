...
export const SOCIAL_NETWORKS: SocialNetworkDefinition[] = [
  ...
  { id: 'pinterest', label: 'Pinterest', short: 'P', domain: 'pinterest.com', uploadPostConnect: 'pinterest', uploadPostPublish: 'pinterest', zernio: 'pinterest', zernioConnectMode: 'oauth' },
  ...
  { id: 'google_business', label: 'Google Business', short: 'G', domain: 'business.google.com', uploadPostConnect: 'google-business', uploadPostPublish: 'google_business', zernio: 'googlebusiness', zernioConnectMode: 'oauth' },
  { id: 'snapchat', label: 'Snapchat', short: '◉', domain: 'snapchat.com', uploadPostConnect: 'snapchat', zernio: 'snapchat', zernioConnectMode: 'oauth' },
