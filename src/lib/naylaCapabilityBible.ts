...
export const NAYLA_CAPABILITY_BIBLE: NaylaCapability[] = [
  ...
  },
  {
    ...
    description: 'Captions sincronizados conectados con estilos clean, cinematic, TikTok, karaoke y minimal, incluyendo palabra activa cuando hay tiempos por palabra.',
    status: 'ready',
    engine: 'render',
