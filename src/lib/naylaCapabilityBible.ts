...
export const NAYLA_CAPABILITY_BIBLE: NaylaCapability[] = [
  ...
  },
  {
    ...
    description: 'Efectos profesionales conectados para video: aberración cromática, glow, zoom blur, pixelado, duotono, grading cinematográfico y viñeta avanzada. Se pueden encadenar hasta cuatro por clip.',
    status: 'ready',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Transiciones avanzadas conectadas entre fotos y videos: blur slide, cross zoom, dreamy zoom, film burn, linear blur y push cut.',
    status: 'ready',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Subtítulos sincronizados conectados con estilos limpio, cinematográfico, TikTok y karaoke con palabra activa.',
    status: 'ready',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Motor instalado para estelas y desenfoque de cámara durante movimientos rápidos.',
    status: 'installed',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Motor moderno de video y audio conectado al render para lectura más precisa, sincronía y efectos sobre video.',
    status: 'ready',
    engine: 'render',
