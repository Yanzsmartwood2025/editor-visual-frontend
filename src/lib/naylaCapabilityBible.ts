...
export const NAYLA_CAPABILITY_BIBLE: NaylaCapability[] = [
  ...
  },
  {
    ...
    description: 'Animación GSAP conectada para entradas y salidas con fade, deslizamientos, zoom, rebote, elasticidad, giro y swing, con duración e intensidad configurables.',
    status: 'ready',
    engine: 'render',
    aliases: ['animacion avanzada', 'rebote', 'trayectoria', 'curva', 'entrada de texto', 'salida de texto', 'coreografia'],
    usefulFor: ['entradas y salidas expresivas', 'motion graphics', 'títulos', 'publicidad', 'animaciones complejas'],
  },
  {
    id: 'three-real',
    category: '3D',
