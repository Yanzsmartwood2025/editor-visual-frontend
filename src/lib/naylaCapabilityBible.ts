...
export const NAYLA_CAPABILITY_BIBLE: NaylaCapability[] = [
  ...
  },
  {
    ...
    description: 'Render 3D real conectado para modelos GLB M1/M2 con cámara, luces, escala, posición, rotación automática y animaciones internas sincronizadas al frame.',
    status: 'ready',
    engine: 'render',
    aliases: ['3d real', 'modelo 3d', 'camara 3d', 'luces 3d', 'materiales 3d', 'escena 3d', 'objeto 3d', 'glb', 'girar modelo', 'presentar producto 3d'],
    usefulFor: ['presentar modelos', 'cámaras 3D', 'productos', 'escenas tridimensionales', 'renders GLB'],
  },
  {
    id: 'motion-blur',
    category: 'Movimiento',
  ...
  },
  {
    ...
    description: 'Motion graphics procedurales conectados y deterministas por frame: partículas orgánicas, órbitas, rejillas pulsantes y campos de estrellas con ruido, velocidad, intensidad y colores configurables.',
    status: 'ready',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Animaciones vectoriales Lottie JSON y Rive .riv conectadas al render, sincronizadas por frame y con control de tiempo, posición, escala, opacidad y parámetros propios de cada formato.',
    status: 'ready',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Motor Skia conectado al render para gráficos avanzados sincronizados por frame: orbes luminosos, anillos, pulsos de energía y focos animados con color, intensidad, velocidad y posición configurables.',
    status: 'ready',
    engine: 'render',
    aliases: ['dibujar', 'grafico avanzado', 'skia', 'canvas', 'orbe', 'anillos', 'pulso de energia', 'luces abstractas'],
    usefulFor: ['motion graphics', 'fondos abstractos', 'gráficos personalizados', 'composición avanzada'],
  },
  {
    id: 'background-removal',
    category: 'Video inteligente',
    label: 'Separación de fondo',
    description: 'Separación de fondo conectada en el navegador con WebGPU. Usa un modo ligero optimizado para personas y un modo general más pesado para otros sujetos; guarda el primer plano transparente como un nuevo video en la Bóveda.',
    status: 'ready',
    engine: 'browser',
  ...
  },
  {
    ...
    description: 'Transcripción local en el navegador con WebGPU y modelos Whisper ligeros, convertida en subtítulos sincronizados con estilos clean, cinematic, TikTok o karaoke.',
    status: 'ready',
    engine: 'browser',
