...
export const NAYLA_CAPABILITY_BIBLE: NaylaCapability[] = [
  ...
  },
  {
    ...
    description: 'Motor avanzado preparado para corrección de color, distorsiones, desenfoques, aberración, pixelado, contornos, luz y efectos encadenados.',
    status: 'installed',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Base instalada para transiciones más complejas como desenfoque, quemado de película, disoluciones y transiciones de profundidad.',
    status: 'installed',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Base instalada para captions sincronizados, SRT, palabra activa y estilos de subtítulos dinámicos.',
    status: 'installed',
    engine: 'render',
  ...
  },
  {
    ...
    description: 'Base instalada para manejo moderno de video y audio, análisis de medios y compatibilidad ampliada.',
    status: 'installed',
    engine: 'render',
