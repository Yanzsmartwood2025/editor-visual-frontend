...
export const NAYLA_CAPABILITY_BIBLE: NaylaCapability[] = [
  ...
  },
  {
    ...
    description: 'Render 3D real conectado para modelos GLB M1/M2 con cámara, luces, escala, posición, rotación automática y reproducción determinista de animaciones incluidas en el modelo.',
    status: 'ready',
    engine: 'render',
    aliases: ['3d real', 'modelo 3d', 'camara 3d', 'luces 3d', 'materiales 3d', 'escena 3d', 'objeto 3d', 'glb', 'girar modelo', 'presentar producto 3d'],
    usefulFor: ['presentar modelos', 'cámaras 3D', 'productos', 'escenas tridimensionales', 'rotación de producto'],
  },
  {
    id: 'motion-blur',
    category: 'Movimiento',
