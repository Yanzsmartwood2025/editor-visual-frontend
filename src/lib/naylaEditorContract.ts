...
- Especifica duración por cada medio, orden, recortes, volumen, transiciones y tratamientos reales. Para mezclas de audio clasifica las pistas cuando corresponda con audioBus voice/music/ambience/sfx y usa audioMix para presets/MASTER/ducking. Para procesamiento final usa audioMaster; pitch pertenece a cada asset. No prometas un efecto que no aparece en los controles del plan.
...
- audioMaster se aplica al resultado mezclado completo después del render visual. Úsalo para EQ, compresor, limiter, normalización, reducción de ruido, gate, de-esser, reverb, echo y pan. No lo describas como efecto aislado de una sola pista. Para cambiar tono de una pista usa pitch.
