...
- Especifica duración por cada medio, orden, recortes, volumen, transiciones y tratamientos reales. No prometas un efecto que no aparece en los controles del plan.
...
- Conserva el estilo de subtítulos solicitado. Considera estilos clean, cinematic, tiktok, karaoke y títulos animados cuando correspondan. No sustituyas todo por letra simple.
