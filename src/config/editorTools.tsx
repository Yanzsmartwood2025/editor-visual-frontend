export const MAIN_TOOLS = [
  ...
  { id: 'boveda', nombre: 'BÓVEDA', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17.5 19H7a5 5 0 0 1-.9-9.92A7 7 0 0 1 19.7 8.3 4.5 4.5 0 0 1 17.5 19Z"/><path d="M12 12v6M9.5 14.5 12 12l2.5 2.5"/></svg> },
  { id: 'resultados', nombre: 'RESULTADOS', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16v16H4z"/><path d="M8 12h8"/><path d="m13 8 4 4-4 4"/><path d="M7 7h3M7 17h3"/></svg> },
  ...
  { id: 'generar', nombre: 'GENERAR', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2 21 7 12 12 3 7 12 2Z"/><path d="M3 7v10l9 5 9-5V7"/><path d="M12 12v10"/></svg> },
  ...
  { id: 'redes', nombre: 'REDES', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="m8.6 10.5 6.8-4M8.6 13.5l6.8 4"/></svg> },
  { id: 'play', nombre: 'NAYLA PLAY', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 8h12a4 4 0 0 1 3.8 5.2l-1.2 3.6A3 3 0 0 1 17.8 19l-3.1-2H9.3l-3.1 2a3 3 0 0 1-2.8-2.2l-1.2-3.6A4 4 0 0 1 6 8Z"/><path d="M8 11v4M6 13h4"/><circle cx="16.5" cy="12.5" r=".8" fill="currentColor" stroke="none"/><circle cx="18.5" cy="14.5" r=".8" fill="currentColor" stroke="none"/></svg> },
  { id: 'pc', nombre: 'NAYLA PC', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="13" rx="2"/><path d="M8 21h8M12 17v4"/><path d="M7 8h10"/></svg> },
  ...
  { id: 'diagnostico', nombre: 'DIAGNÓSTICO', adminOnly: true, icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3 20 6v6c0 5-3.4 8.7-8 10-4.6-1.3-8-5-8-10V6l8-3Z"/><path d="m9 12 2 2 4-5"/></svg> }
];

export const SUB_TOOLS: Record<string, any[]> = {
  editor: [
  ...
  resultados: [
    { id: 'resultado-todo', nombre: 'Todo', isFilter: true, filterValue: 'todo' },
    { id: 'resultado-videos', nombre: 'Videos', isFilter: true, filterValue: 'videos' },
    { id: 'resultado-fotos', nombre: 'Fotos', isFilter: true, filterValue: 'fotos' },
    { id: 'resultado-audios', nombre: 'Audios', isFilter: true, filterValue: 'audios' },
  ],
  generar: [],
  diagnostico: [],
  '3d': [
    { id: 'subir-3d', nombre: 'Subir GLB', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg> },
    { id: 'texto-3d', nombre: 'Texto → 3D', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="4 7 4 4 20 4 20 7"/><line x1="12" y1="4" x2="12" y2="20"/><path d="M16 15l5 3-5 3z"/></svg> },
    { id: 'imagen-3d', nombre: 'Imagen → 3D', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/><path d="M17 4l4 2-4 2z"/></svg> },
    { id: 'multivista-3d', nombre: 'Multivista', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="5" width="8" height="14" rx="2"/><rect x="14" y="5" width="8" height="14" rx="2"/><path d="M10 9h4M10 15h4"/></svg> },
    { id: 'textura-3d', nombre: 'Textura', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="9"/><path d="M8 8h.01M16 8h.01M8 16h.01M16 16h.01M12 12h.01"/></svg> },
    { id: 'optimizar-3d', nombre: 'Optimizar', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16v16H4z"/><path d="m4 4 8 8 8-8M4 20l8-8 8 8"/></svg> },
    { id: 'rig-3d', nombre: 'Rigging', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="4" r="2"/><path d="M12 6v5m0 0-5 4m5-4 5 4m-5-4v8m0 0-4 3m4-3 4 3"/></svg> },
    { id: 'animar-3d', nombre: 'Animar', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="5 3 19 12 5 21 5 3"/></svg> },
  ],
  buscar: [
  ...
  herramientas: [
    { id: 'biblioteca', nombre: 'Biblioteca', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 5a2 2 0 0 1 2-2h5v16H6a2 2 0 0 0-2 2V5Z"/><path d="M20 5a2 2 0 0 0-2-2h-5v16h5a2 2 0 0 1 2 2V5Z"/><path d="M7 7h2M15 7h2"/></svg> },
  ...
  redes: [
    { id: 'social-hub', nombre: 'Publicar', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 16V4"/><path d="m7 9 5-5 5 5"/><path d="M5 20h14"/></svg> },
  ],
  play: [
    { id: 'play-home', nombre: 'Nayla Play', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 8h12a4 4 0 0 1 3.8 5.2l-1.2 3.6A3 3 0 0 1 17.8 19l-3.1-2H9.3l-3.1 2a3 3 0 0 1-2.8-2.2l-1.2-3.6A4 4 0 0 1 6 8Z"/><path d="M8 11v4M6 13h4"/><circle cx="16.5" cy="12.5" r=".8" fill="currentColor" stroke="none"/><circle cx="18.5" cy="14.5" r=".8" fill="currentColor" stroke="none"/></svg> },
  ],
  pc: [
    { id: 'pc-home', nombre: 'Nayla PC', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="13" rx="2"/><path d="M8 21h8M12 17v4"/><path d="M7 8h10"/></svg> },
  ],
  ajustes: [
    { id: 'cristal', nombre: 'Cristal & Luz', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> },
