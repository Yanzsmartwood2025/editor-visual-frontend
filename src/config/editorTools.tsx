export const MAIN_TOOLS = [
  ...
  { id: '3d', nombre: '3D', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2 21 7 12 12 3 7 12 2Z"/><path d="M3 7v10l9 5 9-5V7"/><path d="M12 12v10"/></svg> },
