...
export default function NaylaCore() {
  ...
  // Nuevo estado para la barra de carga
  ...
  const processVideo = async () => {
    ...
    setProgresoCarga(10); // Iniciamos la barra visual
    
    // Simulamos un avance fluido de la barra mientras el servidor trabaja
    ...
    try {
      ...
      clearInterval(intervaloCarga); // Detenemos la simulación
      setProgresoCarga(100); // Llenamos la barra al éxito
      ...
      <main style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        >
          {videoTerminado ? (
            ...
            // FONDO POR DEFECTO CON EL LOGO INTRO
