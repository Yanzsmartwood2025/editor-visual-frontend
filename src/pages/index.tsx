...
type TimelineGsapMotionPreset = 'fade' | 'slide-left' | 'slide-right' | 'slide-up' | 'slide-down' | 'zoom-in' | 'zoom-out' | 'bounce' | 'elastic' | 'spin' | 'swing';
type TimelineGsapMotion = { enter?: TimelineGsapMotionPreset; exit?: TimelineGsapMotionPreset; enterDuration?: number; exitDuration?: number; intensity?: number; };
