...
export default function NaylaCore() {
  ...
  const processVideo = async () => {
    ...
    try {
      // MODIFICACIÓN: Ruta absoluta forzada para saltar los bloqueos de enrutamiento
      ...
      if (res.ok && data.url) {
        ...
        alert(`¡Video subido a la bóveda!\nEnlace: ${data.url}`);
        // Aquí opcionalmente puedes actualizar el reproductor con el video de la nube
